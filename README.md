# graphql-go [![Sourcegraph](https://sourcegraph.com/github.com/kevinwmiller/graphql-go/-/badge.svg)](https://sourcegraph.com/github.com/kevinwmiller/graphql-go?badge) [![Build Status](https://semaphoreci.com/api/v1/kevinwmiller/graphql-go/branches/master/badge.svg)](https://semaphoreci.com/kevinwmiller/graphql-go) [![GoDoc](https://godoc.org/github.com/kevinwmiller/graphql-go?status.svg)](https://godoc.org/github.com/kevinwmiller/graphql-go)
...
- subscriptions
   - [sample WS transport](https://github.com/kevinwmiller/graphql-transport-ws)

## Roadmap

We're trying out the GitHub Project feature to manage `graphql-go`'s [development roadmap](https://github.com/kevinwmiller/graphql-go/projects/1).
...
import (
        ...
        graphql "github.com/kevinwmiller/graphql-go"
        "github.com/kevinwmiller/graphql-go/relay"
)
